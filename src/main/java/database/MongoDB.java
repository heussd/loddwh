...
//							@Override
//							public void apply(Document arg0) {
//								// Hier f�r jeden neue Abfrage mit Filter auf �bereinstimmende Subjects bei nicht �bereinstimmender ID.
//								// Auch �ber die iterieren und dann jeweils alles ins queryResult legen
//								// TODO kl�ren mit DCTERMS_SUBJECT und MULTIPLE ob das so gedacht war. MongoDb d�rfte sich an Arrays aber nicht st�ren.
//							}
//						});
//						return queryResult;
//						
...
//				}
			...
			case NONE:
				switch (queryScenario) {
					...
					// TODO L�schen etwas ung�nstig nachdem alle mit paper auf "recycled trees" gesetzt wurden?
					// Also f�r die Aussage er h�tte so viel so schnell gel�scht. Diese Aussage stimmt dann einfach bei allen Datenbanken hier nicht, wenn vorher das Update l�uft.
